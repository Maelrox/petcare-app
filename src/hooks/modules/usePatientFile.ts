...
export const uploadFile = async (file: File, patientId?: number, description?: string): Promise<string | undefined> => {
  const options = generateRequestOptionsForFileUpload("PUT", file, description)
